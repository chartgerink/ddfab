...
#' Variance analysis
#'
#' @param n Vector of N per subgroup
#' @param sds Vector of SDs per subgroup
#' @param subgroups Factor vector of grouping
#' @param iter Number of iterations
#' @param method Variance analysis operationalization (opt 'sd' or 'maxmin')
#'
#' @return P-value
#' @export
#'
#' @examples
#'   std_var(n = rep(15, 3), sds = c(25.09, 24.58, 25.65), iter = 100, subgroups = rep(1, 3))
